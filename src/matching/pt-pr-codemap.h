...
#if !defined (octave_tree_print_codemap_h)
#define octave_tree_print_codemap_h 1
...
class
tree_print_codemap : public tree_walker
{
public:

  tree_print_codemap (codemap_ostream& os_arg,
...
private:
  ...
  tree_print_codemap (const tree_print_codemap&);

  tree_print_codemap& operator = (const tree_print_codemap&);
};
